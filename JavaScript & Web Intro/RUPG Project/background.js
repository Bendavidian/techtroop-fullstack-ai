(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Custom Shader Material definition
    const material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        // Custom tanh definition for GLSL ES 100/WebGL 1 compatibility
        ...
        void main() {
          ...
          // Standardized WebGL loop syntax with constant loop condition and integer counter
          for (int i = 0; i < 35; i++) {
            float fi = float(i);
          ...
          // Use custom tanh function with safe bounds
          o = custom_tanh(pow(max(o / 100.0, vec4(0.0)), vec4(1.6)));
          gl_FragColor = o * 1.5;
        }
      `
    });

    // 3. Create fullscreen plane mesh and add to scene
    ...
    let frameId;
    const animate = () => {
      material.uniforms.iTime.value += 0.006; // Calm animation speed
    ...
    // Clean up Three.js resources if unloading (good practice)
